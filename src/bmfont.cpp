...
int map_cell(char ch)
{
    ...
    case number:
        return 32 + ch - '0';
    case special:
        return 48 + (unsigned char)ch - 0xF0;
    case invalid:
        return -1;
    }
    return -1;
...
std::unordered_map<char, rectangle> map_blue_large{
    {'A', {0, 240, 16, 16}},
    {'B', {17, 240, 14, 16}},
    {'C', {33, 240, 14, 16}},
    {'D', {49, 240, 14, 16}},
...
std::unordered_map<char, rectangle> map_white_small{
    {'A', {0, 325, 4, 7}},
    {'B', {5, 325, 4, 7}},
    {'C', {10, 325, 4, 7}},
    {'D', {15, 325, 4, 7}},
...
void draw_string_centered(bmfont& f, const bmfont_glyph_map& map, std::string_view text, const rectangle& rect, float r, float g, float b, float a)
{
    auto m = f.measure_string(text, map);
    f.draw_string(map, text, rect.x + rect.w / 2 - m.width / 2, rect.y + rect.h / 2 - m.height / 2, r, g, b, a);
}
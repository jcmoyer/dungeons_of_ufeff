...
st_mainmenu::st_mainmenu(game* g, shared_state* s) : owner{ g }, state{ s } {
}
...
void st_mainmenu::render_game_fade() {
    ...
    const double c = clamp(fade_timer.progress(state->frame_counter), 0.0, 1.0);

...
// clang-format off
constexpr battle_field_properties BF_DUNGEON = { "bf_dungeon", {0.5, -0.3, -0.8}, {0x14 / 255.f, 0x0c / 255.f, 0x1c / 255.f } };
constexpr battle_field_properties BF_SANCTUM = { "bf_sanctum", {0.2, -0.8, -0.2}, {0x59 / 255.f, 0x7d / 255.f, 0xce / 255.f } };
constexpr battle_field_properties BF_LAIR    = { "bf_lair",    {0.2, -0.8, -0.2}, {0xd0 / 255.f, 0x46 / 255.f, 0x48 / 255.f } };
// clang-format on

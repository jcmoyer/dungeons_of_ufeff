...
struct tile {
  ...
  bool collides_from(direction d) const {
    ...
    switch (d) {
    case right: return flags & from_right;
    case left:  return flags & from_left;
    case up:    return flags & from_top;
    case down:  return flags & from_bottom;
    }
    return false;
  }
...
struct tilemap {
  ...
  bool can_move_from(uint32_t x, uint32_t y, direction d) const {
    ...
    switch (d) {
    case left:  return flags & move_left;
    case right: return flags & move_right;
    case up:    return flags & move_up;
    case down:  return flags & move_down;
